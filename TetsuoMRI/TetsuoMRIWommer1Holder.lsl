vector home = <-2.0, 0.0, 0.0>;
vector ready= <-2.0, 0.0, 0.0>;

vector ehome = <0,  00  , 0>;
vector eready =<0,  00  , 0>;
...
default
{
    ...
    listen(integer channel, string name, key id, string message)
    {
        ...
        if (name == "TetsuoMRIFrame" & command == "here")
        {
            ...
            //setPosRot(home,ehome);
        } 
        else if (name == "TetsuoMRIWommer1" & command == "move")
        {
