...
// Scan Constants
integer gxduration = 75; // tenths ofseconds
integer gyduration = 95; // 
integer gzduration = 55; // 
integer grollduration = 15; // X
integer gpitchduration = 30; // Y
integer gyawduration = 25; // Z
...
setPosRot(vector desiredPosition, vector desiredEuler)
{
    ...
    llWhisper(19882,"move,"+(string)desiredWorldPos+","+(string)desiredWorldRot);
