...
// Reality is that people hate the battery feature. So it will always be in a benign mode. 
// There will be no "Battery" button in Settings and there will be no recharging. 
...
//string batteryActive = "Off"; // this is the variable that controls whether the thing dies on battery death
...
dischargeBattery(string why, integer seconds)
{
    ...
    // automatically rehcarge if battery gets discharged
    if (batteryCharge <= 0) {
        //if (batteryActive == "ON") {
        //    batteryCharge = 0;
        //} else {
...
default
{
    ...
    link_message(integer sender_num, integer num, string json, key id){
        ...
        // This stays in even though unused. Maybe it will get used in future. 
